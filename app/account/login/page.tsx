...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-sm px-6 py-24">
      <h1 className="font-display text-2xl font-extrabold text-white">Sign In</h1>
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        No account?{" "}
        <Link href="/account/signup" className="font-semibold text-amber-400 hover:text-amber-300">
          Sign up
        </Link>{" "}
        — or just{" "}
